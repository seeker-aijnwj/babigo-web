...
class FleetManagerListWidget extends StatefulWidget {
  const FleetManagerListWidget({super.key});

  @override
  State<FleetManagerListWidget> createState() => _FleetManagerListWidgetState();
}

class _FleetManagerListWidgetState extends State<FleetManagerListWidget> {
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    ...
                    child: _getAllFleetManagersList(),
                  ),
                ],
              ),
            ),
  ...
  Widget _getAllFleetManagersList() {
    return StreamBuilder<QuerySnapshot>(
      stream: AdminDataService.streamFleetManagers(),
