...
import 'package:babigo/app/core/utils/ugo_responsive.dart';
        ...
        builder: (context, snap) {
          ...
          return Column(
            ...
            children: [
              ...
              FilledButton.icon(
                style: FilledButton.styleFrom(backgroundColor: AppColors.secondColor),
                onPressed: () async {
  ...
  Future<void> _refaireSimilaireViaDraft(
    ...
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const DriverMainScreen(initialIndex: 1),
        ),
      );
    } catch (e) {
  ...
  Widget _tile({required String title, required String value}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.secondColor.withValues(alpha: .06),
