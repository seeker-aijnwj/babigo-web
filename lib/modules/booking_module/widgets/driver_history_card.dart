      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Icon(Icons.credit_card, size: 36, color: AppColors.secondColor),
              ...
              const Icon(Icons.arrow_forward, size: 24, color: AppColors.secondColor),
              const SizedBox(width: 8),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.secondColor.withValues(alpha: .05),
          ...
          const Row(
            ...
            children: [
              Icon(Icons.badge_outlined, color: AppColors.secondColor),
              Icon(Icons.analytics_outlined, color: AppColors.secondColor),
              Icon(Icons.phone_android_outlined, color: AppColors.secondColor),
            ],
          ),
