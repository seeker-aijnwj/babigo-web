...
import 'package:babigo/modules/booking_module/screens/onboarding/views/driver_transition_screen.dart';
import 'package:babigo/modules/booking_module/screens/onboarding/views/welcome_screen.dart';
import 'package:babigo/modules/booking_module/screens/passenger/history_screen.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            context.findAncestorStateOfType<PassengerMainScreenState>()?.navigateToTab(
              0,
            );
          },
        ),
