import 'package:babigo/modules/admin_module/screens/selector_screen.dart';
import 'package:flutter/material.dart';
import 'package:babigo/modules/admin_module/database/models/dispute.dart';
...
class _SettingsViewState extends State<SettingsView> {
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        _buildMenuTile("switch", Icons.switch_access_shortcut, "Mode d'utilisateur", "Changer de mode en cliquant ici"),
                      ],
                    ),
                  ),
                  _buildLogoutButton(),
  ...
  Widget _getSectionWidget() {
    switch (_selectedSection) {
      ...
      case 'switch': return SelectorScreen();
