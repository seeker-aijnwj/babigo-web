...
import 'package:babigo/app/database/services/ride_service.dart';
...
import 'package:babigo/modules/trip_module/services/trip_status_service.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: AppColors.secondColor.withValues(alpha: .25), width: 1),
        boxShadow: [
          BoxShadow(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.stop_circle_outlined, size: 16, color: AppColors.secondColor),
