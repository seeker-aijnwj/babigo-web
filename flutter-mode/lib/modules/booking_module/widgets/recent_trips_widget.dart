...
import 'package:babigo/modules/booking_module/services/reservation_history_service.dart';

// 👉 Ajuste ce chemin selon ton projet
import 'package:babigo/modules/booking_module/screens/passenger/history_screen.dart'; // change si nécessaire
...
class _AnimatedCarIconState extends State<_AnimatedCarIcon>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      child: Icon(Icons.directions_car, color: AppColors.mainColor, size: 20),
    );
  }
}
