...
import 'package:babigo/app/widgets/form_component.dart';
      ...
      children: [
        ...
        _buildBubbleForm(
          child: PlaceAutocompleteField(
            ...
            prefixIcon: Icon(
                Icons.location_on_outlined, color: AppColors.secondColor),
            onSelected: (p) {
        ...
        _buildBubbleForm(
          child: PlaceAutocompleteField(
            ...
            prefixIcon: Icon(
                Icons.flag_outlined, color: AppColors.secondColor),
        ...
        _buildBubbleForm(
          child: FormComponent(
            ...
            prefixIcon: Icon(Icons.location_city_outlined, color: AppColors.secondColor),
            borderNone: true,
          ),
        ),
        _buildBubbleForm(
          child: FormComponent(
            ...
            onChanged: (_) => _emitChange(),
            prefixIcon: Icon(Icons.place_outlined, color: AppColors.secondColor),
            borderNone: true,
          ),
        ),
          ...
          child: GestureDetector(
            ...
            child: AbsorbPointer(
              child: FormComponent(
                ...
                prefixIcon: Icon(Icons.access_time, color: AppColors.secondColor),
                borderNone: true,
              ),
            ),
          ),
        ...
        _buildBubbleForm(
          child: FormComponent(
            ...
            prefixIcon: Icon(Icons.person_outline, color: AppColors.secondColor),
            borderNone: true,
          ),
        ),
        _buildBubbleForm(
          child: FormComponent(
            ...
            onChanged: (_) => _emitChange(),
            textInputType: TextInputType.number,
            prefixIcon: Icon(Icons.attach_money, color: AppColors.secondColor),
            borderNone: true,
          ),
        ),
      ],
