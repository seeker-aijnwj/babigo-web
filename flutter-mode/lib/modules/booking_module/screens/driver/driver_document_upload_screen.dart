...
import 'package:babigo/modules/booking_module/widgets/driver_document_form.dart';
import 'package:babigo/app/widgets/button_component.dart';
import 'package:babigo/app/core/utils/colors.dart';
import 'package:babigo/modules/booking_module/screens/onboarding/views/announce_success_screen.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ButtonComponent(
              txtButton: "Valider",
              colorButton: allDocsProvided ? AppColors.secondColor : Colors.grey,
