...
import 'package:babigo/app/database/services/wallet_service.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Icon(Icons.trip_origin, size: 18, color: AppColors.mainColor),
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Icon(Icons.flag, size: 18, color: AppColors.mainColor),
              const SizedBox(width: 8),
              Expanded(
                child: TxtComponents(
                  txt: widget.arrival,
          ...
          ButtonComponent(
            ...
            colorButton: _isLoading ? Colors.grey : AppColors.secondColor,
...
class _StopChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Chip(
      ...
      backgroundColor: AppColors.mainColor..withValues(alpha: .08),
      shape: StadiumBorder(
        side: BorderSide(color: AppColors.mainColor..withValues(alpha: .25)),
      ),
      avatar: const Icon(Icons.route, size: 16, color: AppColors.mainColor),
      label: Text(
        label,
