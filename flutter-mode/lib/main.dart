...
import 'modules/admin_module/screens/admin_welcome_screen.dart';
...
class BabiGoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // home: const AuthGuard(child: AdminWelcomeScreen()),
      home: const AdminWelcomeScreen(),  // <--- Lancez le sélecteur
    );
  }
}